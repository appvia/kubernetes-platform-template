# Kubernetes Platform Example Repository
...
You can see view the platform here: https://github.com/appvia/kubernetes-platform
...
- `config` - Contains configuration for override the platform defaults.
